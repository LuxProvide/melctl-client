...
class Endpoint:
    """Generic endpoint command line parser.
    """
    ...
    def format_table(self, args, data):
        ...
        # - Synchronous or finished task result: use endpoint headers
    ...
    def __call__(self, args):
        """Runs and wraps the endpoint function.
    ...
    def render(self, args, data):
        """Renders (post-process) endpoint result after completion.
